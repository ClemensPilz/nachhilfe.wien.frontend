    ...
    <div @click.stop="" class="max-h-screen bg-white py-6 px-10 mx-2 mt-20 rounded-xl">
      ...
      <div>
        ...
        <form>
          ...
          <input type="text" name="text" v-model="text" placeholder="Mein Review...">
      ...
      <div class="flex gap-2 justify-end">
        <button class="mt-4 w-fit py-2 px-4 bg-lightPrimary text-white rounded-xl" @click="closeModal">Schließen</button>
        <button class="mt-4 w-fit py-2 px-4 bg-accent text-white rounded-xl" @click="login">Absenden</button>
      </div>
    </div>
  </div>
</template>
