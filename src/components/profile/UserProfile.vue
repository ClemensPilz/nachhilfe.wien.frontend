      ...
      <section v-else id="userProfile">
        ...
        <div class="container min-h-screen max-w-7xl mx-auto px-2 mt-8">
          ...
          <div class="w-full grid grid-cols-2 gap-4 items-center">
            ...
            <!--Teacher Information-->
            <div v-if="userType === 'TEACHER'" id="teacherInformation" class="col-span-2 md:col-span-1">
              <ul>
                <li>
            ...
            <!--Student Information-->
            <div v-else id="studentInformation" class="col-span-2 md:col-span-1">
              <h1 class="text-mainOrange">?</h1>
              <div>
                <h3>{{ profile.firstName }} {{ profile.lastName }}</h3>
                <p>{{ profile.description }}</p>
          ...
          <!--Comments-->
          <div class="col-span-2 my-4" v-if="userType === 'TEACHER' && profile.feedbacks.length > 0 ">
